...
var EvmWalletProvider = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(EvmWalletContext.Provider, { value: {
            ...
            wagmi: wagmi,
            viem: viem,
        }, children: (0, jsx_runtime_1.jsx)(wagmi_1.WagmiProvider, { config: cachedWagmiAdapter.wagmiConfig, children: (0, jsx_runtime_1.jsx)(react_query_1.QueryClientProvider, { client: queryClient, children: children }) }) }));
};
